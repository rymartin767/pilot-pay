    ...
    <div class="w-full flex flex-col max-w-xl mx-auto">
        ...
        <ul class="space-y-4 divide-y divide-gray-200">
            <li class="flex items-center pt-3">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" class="h-6 w-6 fill-current text-gray-400">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center ml-4 font-poppins">
                    <div class="font-normal pt-1">Gross W2 Wages:</div>
                    <div class="font-light pt-1 sm:ml-2 text-xl sm:text-base">{{ Number::currency($report->earnings->flight_pay ) }}</div>
                </div>
            </li>
            <li class="flex items-center pt-3">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="h-6 w-6 fill-current text-gray-400">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center ml-4 font-poppins">
                    <div class="font-normal pt-1">Company Retirement Contribution:</div>
            ...
            <li class="flex items-center pt-3">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="h-6 w-6 fill-current text-slate-400">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center ml-4 font-poppins">
                    <div class="font-normal pt-1">Company Profit Sharing/Bonus:</div>
            ...
            <li class="flex items-center pt-3">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center ml-4 font-poppins">
                    <div class="font-normal pt-1">Company Health Savings Contribution:</div>
            ...
            <li class="flex items-center pt-3">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="h-6 w-6 fill-current text-stone-400"><!--! Font Awesome Pro 6.1.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                ...
                <div class="flex flex-col sm:flex-row sm:items-center ml-4 font-poppins">
                    <div class="font-normal pt-1">Days Worked:</div>
                    <div class="font-light pt-1 sm:ml-2 text-xl sm:text-base">{{ $report->earnings->days_worked }}</div>
                </div>
            </li>
            <li class="flex items-center pt-3">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="h-6 w-6 fill-current text-purple-400"><!--! Font Awesome Pro 6.1.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                    <path d="M256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256C512 397.4 397.4 512 256 512zM232 256C232 264 236 271.5 242.7 275.1L338.7 339.1C349.7 347.3 364.6 344.3 371.1 333.3C379.3 322.3 376.3 307.4 365.3 300L280 243.2V120C280 106.7 269.3 96 255.1 96C242.7 96 231.1 106.7 231.1 120L232 256z" />
                </svg>
                <div class="flex flex-col sm:flex-row sm:items-center ml-4 font-poppins">
                    <div class="font-normal pt-1">Block Hours Flown:</div>
                    <div class="font-light pt-1 sm:ml-2 text-xl sm:text-base">{{ $report->earnings->block_hours_flown }} Hours</div>
                </div>
            </li>
            <li class="flex items-center pt-3">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="h-6 w-6">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center ml-4 font-poppins">
                    <div class="font-normal pt-1">Commute:</div>
            ...
            <li class="pt-3">
                <div class="flex items-center">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center ml-4 font-poppins">
                        <div class="font-normal pt-1">Report Comments:</div>
                    </div>
                </div>
